...
| Paper                                                        | Code      | Venue      | Year | PTQ | QAT | Weight | Activation |Type |
| ------------------------------------------------------------ | ----------| ---------- | ---- | :-: | :-: | :----: | :--------: |---- |
| [Stabilized activation scale estimation for precise Post-Training Quantization](https://www.sciencedirect.com/science/article/pii/S0925231223012432) |[![GitHub Repo stars](https://img.shields.io/github/stars/hustvl/StablePTQ)](https://github.com/hustvl/StablePTQ)| Neurocomputing | 2024 | ✔️ | ❌ | | | |
